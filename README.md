...
# Tesseract
This program manually interacts with a half screen page of LinkedIn using Pytesseract, pyautogui, and computer vision to see what is currently on the screen. This method is emulates mouse and keystrokes and is more inefficient than using Selenium but becomes necessary when dealing with non-HTML.
